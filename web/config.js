    ...
    list: [
      {
        ...
        limits: { aiMessages: 30, habits: 3, goals: 1, wishes: 3, business: false, autoSubs: false, export: false },
        features: [
          'Finanças, hábitos e tarefas',
          'Comandos por texto e voz',
          '30 mensagens com a IA por mês',
          'Até 3 hábitos e 1 meta de economia',
          'Até 3 itens em "Quero comprar", com aviso ao juntar o valor',
        ],
      },
      {
        id: 'medio',
        ...
        annual: null,
        checkout: { monthly: '', annual: '' },
        limits: { aiMessages: 300, habits: 10, goals: 5, wishes: 15, business: true, autoSubs: true, export: false },
        features: [
          'Tudo do Básico',
          '300 mensagens com a IA por mês',
          'Até 10 hábitos e 5 metas',
          'Até 15 itens em "Quero comprar"',
      ...
      },
      {
        ...
        annual: null,
        checkout: { monthly: '', annual: '' },
        limits: { aiMessages: null, habits: null, goals: null, wishes: null, business: true, autoSubs: true, export: true },
        features: [
          'Tudo do Médio',
          'IA sem limite de mensagens',
          'Hábitos, metas e itens de compra ilimitados',
